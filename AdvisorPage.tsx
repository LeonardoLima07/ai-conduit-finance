    ...
    try {
      const resp = await fetch(CHAT_URL, {
        ...
        headers: {
          ...
          // Token real da sessão do usuário — necessário para a edge function
          // conseguir rodar as tools com RLS (dados isolados por empresa).
          // NUNCA usar a anon/publishable key aqui: ela não identifica o usuário.
