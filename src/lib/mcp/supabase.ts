...
export function notAuthenticated() {
  return {
    content: [{ type: "text" as const, text: "Não autenticado. Conecte sua conta Contuit novamente." }],
    isError: true,
  };
}

/** Resolves the signed-in user's company (RLS scoped). */
export async function resolveCompany(ctx: ToolContext) {
